...
import { AlertCircle, BarChart3, Check, ChevronDown, Copy, TrendingDown, TrendingUp } from "lucide-react";
    ...
    <Collapsible open={isExpanded} onOpenChange={setIsExpanded}>
      <Card className={`relative border-l-4 ${getHealthColor()} transition-all hover:shadow-lg`}>
            ...
            <div className="mt-4 pt-4 border-t">
              <div className="grid grid-cols-2 gap-3 text-sm">
                <div>
                  ...
                  <p className="font-semibold text-lg">{Number(provider.weekly!.dealSuccessRate).toFixed(1)}%</p>
                  <p className="text-xs text-muted-foreground">{provider.weekly!.totalDeals} attempts (7d)</p>
                </div>
                <div>
                  <p className="text-xs text-muted-foreground mb-1">Retrieval Success</p>
                  <p className="font-semibold text-lg">{Number(provider.weekly!.retrievalSuccessRate).toFixed(1)}%</p>
                  <p className="text-xs text-muted-foreground">{provider.weekly!.totalRetrievals} attempts (7d)</p>
                </div>
              </div>
            </div>
          )}
        ...
        <CardContent className="space-y-4 pt-0">
          ...
          {/* Collapsible Content - Detailed Stats */}
              ...
              <>
                    ...
                    {provider.allTime!.totalIpniDeals > 0 && (
                      <div className="space-y-1.5 pt-2">
                        ...
                        <div className="pl-2 space-y-1">
                          ...
                          <LatencyMetricRow
                            label="Time to Advertise"
                            value={provider.allTime!.avgIpniTimeToAdvertiseMs}
                          />
                          <LatencyMetricRow
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    {provider.allTime!.totalIpfsRetrievals > 0 &&
                      provider.allTime!.avgIpfsRetrievalThroughputBps > 0 && (
                        <div className="space-y-1">
