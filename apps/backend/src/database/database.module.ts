...
import type { IAppConfig, IConfig, IDatabaseConfig } from "../config/index.js";
...
import { PullPiece } from "./entities/pull-piece.entity.js";
...
@Module({
  imports: [
    TypeOrmModule.forRootAsync({
      ...
      useFactory: (configService: ConfigService<IConfig, true>) => {
        ...
        return {
          ...
          entities: [DataRetentionBaseline, Deal, PullPiece, StorageProvider, Retrieval, JobScheduleState],
    ...
    TypeOrmModule.forFeature([Deal, PullPiece, StorageProvider, Retrieval, JobScheduleState]),
  ],
  providers: [Deal, PullPiece, StorageProvider, Retrieval, JobScheduleState],
  exports: [Deal, PullPiece, StorageProvider, Retrieval, JobScheduleState],
})
