...
const metricProviders = [
  ...
  makeHistogramProvider({
    ...
    labelNames: ["checkType", "providerId", "providerName", "providerStatus", "value", "indexer", "network"] as const,
  ...
  makeGaugeProvider({
    ...
    labelNames: ["status", "network"] as const,
  }),
  makeGaugeProvider({
  ...
  makeCounterProvider({
    ...
    help: "Data-set termination attempts by sp_data_set_pruning / abandoned_data_set_sweep",
    labelNames: ["network", "outcome", "reason"] as const,
  }),
  makeGaugeProvider({
    name: "sp_termination_stuck_gauge",
    help: "Current count of terminated data sets whose rail settlement is stuck past endEpoch, recomputed fresh every abandoned_data_set_sweep run",
    labelNames: ["network"] as const,
  }),
  ...
  makeGaugeProvider({
    ...
    labelNames: ["job_type", "network"] as const,
  }),
  /**
  ...
  makeCounterProvider({
    ...
    labelNames: ["job_type", "outcome", "network"] as const,
  }),
  /**
  ...
  makeCounterProvider({
    ...
    labelNames: ["job_type", "handler_result", "network"] as const,
  }),
  /**
