...
type JobType = "deal" | "retrieval" | "metrics" | "metrics_cleanup" | "data_retention_poll";
...
export class JobsService implements OnModuleInit, OnApplicationShutdown {
  ...
  private async updateQueueMetrics(): Promise<void> {
    const jobTypes: JobType[] = ["deal", "retrieval", "metrics", "metrics_cleanup", "data_retention_poll"];
