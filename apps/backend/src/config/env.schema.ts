...
export const createPerNetworkEnvSchema = (prefix: Uppercase<Network> | "") => {
  ...
  return {
    ...
    [k("SUBGRAPH_ENDPOINT")]: Joi.string().uri().optional().allow(""),
    ...
    [k("SAMPLED_RETRIEVALS_PER_SP_PER_HOUR")]: Joi.number().min(0.001).max(20).optional(),
    ...
    [k("SAMPLED_RETRIEVAL_JOB_TIMEOUT_SECONDS")]: Joi.number().min(60).default(360),
