...
| `SUBGRAPH_ENDPOINT`           | Subgraph GraphQL endpoint for sampled-retrieval queries | `https://api.goldsky.com/api/public/<project>/subgraphs/dealbot-subgraph/<version>/gn` |
