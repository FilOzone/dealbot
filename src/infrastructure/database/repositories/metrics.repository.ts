...
export class MetricsRepository implements IMetricsRepository {
    ...
    await this.dailyMetricsRepository.upsert(
      {
        ...
        avgIngestThroughput: metrics.avgIngestThroughput,
  ...
  private toDailyMetricsData(entity: DailyMetricsEntity): DailyMetricsData {
    return {
      ...
      avgIngestThroughput: entity.avgIngestThroughput || undefined,
      ...
      avgRetrievalThroughput: entity.avgRetrievalThroughput || undefined,
