...
import { type TimeWindow, TimeWindowSelector } from "./TimeWindowSelector";
...
export function ProviderDetailModal({ provider, open, onOpenChange }: ProviderDetailModalProps) {
