...
| <a id="ipniAdvertisedToVerifiedMs"></a>`ipniAdvertisedToVerifiedMs` | Data Storage | [`spAnnouncedAdvertisementToIpni`](#spAnnouncedAdvertisementToIpni) | [`ipniVerificationComplete`](#ipniVerificationComplete) | Only emitted on successful verification. Logs a warning when > 5s. | [`ipni.strategy.ts`](../../apps/backend/src/deal-addons/strategies/ipni.strategy.ts) |
