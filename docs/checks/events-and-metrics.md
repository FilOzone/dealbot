...
| <a id="anonCarParseStatus"></a>`anonCarParseStatus` | Anonymous Retrieval | [`anonCarParsed`](#anonCarParsed), **or** when CAR parsing didn't run (records `skipped`) | `parseable`, `not_parseable`, `skipped`, `error` from [Anonymous Retrieval Sub-status meanings](./anon-retrievals.md#sub-status-meanings). | [`anon-retrieval.service.ts`](../../apps/backend/src/retrieval-anon/anon-retrieval.service.ts) |
