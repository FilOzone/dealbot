...
| `retrieval_sampled` | `sp.work` | [`JobsService.handleSampledRetrievalJob`](../apps/backend/src/jobs/jobs.service.ts) | `{ jobType: 'retrieval_sampled', spAddress, intervalSeconds }` | [sampled retrieval check](./checks/sampled-retrievals.md) |
...
- Per-SP execution-minutes per hour = `(deals_per_sp_per_hour * deal_max_minutes) + (retrievals_per_sp_per_hour * retrieval_max_minutes) + (sampled_retrievals_per_sp_per_hour * sampled_retrieval_max_minutes) + (piece_cleanup_per_sp_per_hour * cleanup_max_minutes) + (pull_checks_per_sp_per_hour * pull_check_max_minutes)`
...
Example (18 SPs, 4 deals/hr @ 5m, 6 retrievals/hr @ 2m, 2 sampled retrievals/hr @ 3m, 1 / 24 piece cleanup/hr @ 5m, 1 pull check/hr @ 5m, 5 dealbot workers, `PG_BOSS_LOCAL_CONCURRENCY=20`):
